...
func TestNormaliseHost(t *testing.T) {
	tests := []struct {
		...
		{name: "mismatched port", url: "https://EXAMPLE.com:443/path", host: "example.com:8443", want: "example.com:443"},
		{name: "mismatched custom ports", url: "https://EXAMPLE.com:8443/path", host: "example.com:9443", want: "example.com:8443"},
		{name: "different scheme default port", url: "http://EXAMPLE.com/path", host: "example.com:443", want: "example.com"},
		...
		{name: "mismatched IPv6 port", url: "https://[::1]:443/path", host: "[::1]:8443", want: "[::1]:443"},
